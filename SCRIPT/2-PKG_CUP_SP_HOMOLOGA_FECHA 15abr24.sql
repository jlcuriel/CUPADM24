...
-- Modificación: Se Actualizo la logica conforme el diagram enviado por Arturo Dúran el DÃ¬a 05/04/2023
...
-- Modificación: 11 Diciembre 2023, conforme observaciones enviadas por El Area de Analisis (Arturo Dúran),
...
BEGIN
    ...
    OPEN CR_VERIFICA_SF;
        ...
        --La fecha transcurrida de la Evaluación de Control de Confianza es mayor a 3 anios 0 meses 0 dias (1)
            IF FN_CALCULA_MESESDIAS(REGCR_VERIFICA_SF.FECHA_EVALUACION_ECCC) < 36.0
            THEN
            BEGIN
            IF REGCR_VERIFICA_SF.ID_COMPETENCIA_BASICA != 0 THEN --¿Existe registro de la evaluación de Competencias Basicas en el CUP ?

                --La fecha de la Competencia BÃ¡sica es 5 anios <= a la fecha actual?    
